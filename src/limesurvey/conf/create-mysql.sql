...
-- Secondary indexes
--
CREATE INDEX `answers_idx2` ON `answers` (`sortorder`);
CREATE INDEX `assessments_idx2` ON `assessments` (`sid`);
CREATE INDEX `assessments_idx3` ON `assessments` (`gid`);
CREATE INDEX `conditions_idx2` ON `conditions` (`qid`);
CREATE INDEX `conditions_idx3` ON `conditions` (`cqid`);
CREATE INDEX `groups_idx2` ON `groups` (`sid`);
CREATE INDEX `question_attributes_idx2` ON `question_attributes` (`qid`);
CREATE INDEX `question_attributes_idx3` ON `question_attributes` (`attribute`);
CREATE INDEX `questions_idx2` ON `questions` (`sid`);
CREATE INDEX `questions_idx3` ON `questions` (`gid`);
CREATE INDEX `questions_idx4` ON `questions` (`type`);
CREATE INDEX `saved_control_idx2` ON `saved_control` (`sid`);
CREATE INDEX `quota_idx2` ON `quota` (`sid`);
CREATE INDEX `parent_qid_idx` ON `questions` (`parent_qid`);
...
-- Version Info
--
INSERT INTO `settings_global` VALUES ('DBVersion', '260');
